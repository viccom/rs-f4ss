...
//! markdown parser, Prism theme) at a reserved `/_static/` path. The HTML
//! viewer lazy-loads them on first text/markdown preview, so the directory
//! listing itself stays light and asset fetches are cacheable across files.
//!
